...
console.log(+tmp);
console.log(typeof +tmp);  //number(자동 형변환)
...
tmp = true;
console.log(+tmp);
console.log(typeof +tmp);  //number(자동 형변환), true = 1, false = 0
 ...
 * &&를 사용했을 때 죄측이 false면 좌측값 반환
 * 
 * ||를 사용했을 때 좌측이 true면 좌측값 반환
 * ||를 사용했을 때 죄측이 false면 우측값 반환
 */

console.log(true || "gayeon");
console.log(false || "gayeon");
console.log(true && "gayeon");
console.log(false && "gayeon");
